...
// Function for printing out ASCII for misses count. 
...
// Greeting function that only outputs to the screen. 
void greet() {
...
// Checking if the player has won and printing out a message. 
